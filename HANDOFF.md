...
## Komponenten-Map (`app/`)
- `page.tsx` — Reihenfolge: Navbar · Hero · HardDrive(3D) · Releases · Sets · About · DemoDrop · Footer
...
## Offene To-Dos
1. **SoundCloud-Player** sind weiß (kein Dark-Mode) → später Custom Dark-Player. Bewusst zurückgestellt.
2. Emiliano gibt Bauchgefühl-Feedback nach Live-Sichtung (Desktop + Handy), dann committen + pushen.
